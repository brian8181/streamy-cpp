...
#line 22 "calc.y"
                 { printf("%d\n", yyvsp[0]); }
#line 1086 "build/calc.tab.c"
    break;

  case 5: /* statement: VARIABLE '=' expr  */
#line 23 "calc.y"
                                { sym[yyvsp[-2]] = yyvsp[0]; }
#line 1092 "build/calc.tab.c"
    break;

  case 7: /* expr: VARIABLE  */
#line 27 "calc.y"
                       { yyval = sym[yyvsp[0]]; }
#line 1098 "build/calc.tab.c"
    break;

  case 8: /* expr: expr '+' expr  */
#line 28 "calc.y"
                            { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1104 "build/calc.tab.c"
    break;

  case 9: /* expr: expr '-' expr  */
#line 29 "calc.y"
                            { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1110 "build/calc.tab.c"
    break;

  case 10: /* expr: expr '*' expr  */
#line 30 "calc.y"
                            { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1116 "build/calc.tab.c"
    break;

  case 11: /* expr: expr '/' expr  */
#line 31 "calc.y"
                            { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1122 "build/calc.tab.c"
    break;

  case 12: /* expr: '(' expr ')'  */
#line 32 "calc.y"
                           { yyval = yyvsp[-1]; }
#line 1128 "build/calc.tab.c"
    break;


#line 1132 "build/calc.tab.c"
