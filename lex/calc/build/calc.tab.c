...
#line 20 "calc.y"
                              { printf("%d\n", (yyvsp[-1].num)); }
#line 1063 "build/calc.tab.c"
    break;

  case 4: /* expr: INTEGER  */
#line 24 "calc.y"
                    { (yyval.num) = (yyvsp[0].num); }
#line 1069 "build/calc.tab.c"
    break;

  case 5: /* expr: expr '+' expr  */
#line 25 "calc.y"
                            { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1075 "build/calc.tab.c"
    break;

  case 6: /* expr: expr '-' expr  */
#line 26 "calc.y"
                            { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1081 "build/calc.tab.c"
    break;


#line 1085 "build/calc.tab.c"
