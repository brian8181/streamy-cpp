...
#line 29 "calc.y"
                 { printf("%d\n", yyvsp[0]); }
#line 1083 "build/calc.tab.c"
    break;

  case 5: /* statement: VARIABLE '=' expr  */
#line 30 "calc.y"
                                { sym[yyvsp[-2]] = yyvsp[0]; }
#line 1089 "build/calc.tab.c"
    break;

  case 7: /* expr: VARIABLE  */
#line 34 "calc.y"
                       { yyval = sym[yyvsp[0]]; }
#line 1095 "build/calc.tab.c"
    break;

  case 8: /* expr: expr '+' expr  */
#line 35 "calc.y"
                            { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1101 "build/calc.tab.c"
    break;
...
#line 39 "calc.y"
                           { yyval = yyvsp[-1]; }
#line 1125 "build/calc.tab.c"
    break;


#line 1129 "build/calc.tab.c"
