 ...
 * @return : bool, true file exsit otherwise false
 */
 ...
 * @param  : ifstream& strm, file stream to read
...
/**
 * @brief  : getc, read stream buffer into a string stream
 * @param  : const string& file
 * @param  : stringstream& ostrm, output stream
 * @return : stringstream&
 */
stringstream& getc( const string& file, /* out */ stringstream& ostrm)
{
